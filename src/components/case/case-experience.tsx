      ...
      {locked ? <>
        ...
        <section className="desktop-space" aria-labelledby="desktop-title">
          ...
          <div className="desktop-icons">
            ...
            <button className="desktop-icon is-disabled" disabled aria-label="CyberChef is coming soon"><FlaskConical /><strong>CYBERCHEF</strong><span>COMING SOON</span></button>
          </div>
